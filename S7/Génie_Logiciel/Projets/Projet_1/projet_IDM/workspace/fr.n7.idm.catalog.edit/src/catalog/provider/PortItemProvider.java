...
/**
 * This is the item provider adapter for a {@link catalog.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CatalogPackage.Literals.PORT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addXPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_x_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_x_feature", "_UI_Port_type"),
				 CatalogPackage.Literals.PORT__X,
				 true,
				 false,
				 false,
	...
	protected void addYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_y_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_y_feature", "_UI_Port_type"),
				 CatalogPackage.Literals.PORT__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CatalogPackage.Literals.PORT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
