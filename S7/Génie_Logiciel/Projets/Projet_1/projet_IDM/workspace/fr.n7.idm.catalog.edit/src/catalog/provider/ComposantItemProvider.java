...
/**
 * This is the item provider adapter for a {@link catalog.Composant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComposantItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFabricantPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CatalogPackage.Literals.COMPOSANT__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Fabricant feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFabricantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Composant_fabricant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Composant_fabricant_feature", "_UI_Composant_type"),
				 CatalogPackage.Literals.COMPOSANT__FABRICANT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CatalogPackage.Literals.COMPOSANT__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CatalogPackage.Literals.COMPOSANT__METADONNEES);
			childrenFeatures.add(CatalogPackage.Literals.COMPOSANT__EMPREINTE);
			childrenFeatures.add(CatalogPackage.Literals.COMPOSANT__PORTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CatalogPackage.Literals.COMPOSANT__METADONNEES,
				 CatalogFactory.eINSTANCE.createMetadonnee()));

		newChildDescriptors.add
			(createChildParameter
				(CatalogPackage.Literals.COMPOSANT__EMPREINTE,
				 CatalogFactory.eINSTANCE.createEmpreinte()));

		newChildDescriptors.add
			(createChildParameter
				(CatalogPackage.Literals.COMPOSANT__PORTS,
				 CatalogFactory.eINSTANCE.createPort()));
	}
