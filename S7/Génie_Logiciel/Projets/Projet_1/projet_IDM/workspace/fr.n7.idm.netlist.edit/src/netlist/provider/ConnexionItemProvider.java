...
public class ConnexionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connexion_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connexion_port_feature", "_UI_Connexion_type"),
				 NetlistPackage.Literals.CONNEXION__PORT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connexion_net_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connexion_net_feature", "_UI_Connexion_type"),
				 NetlistPackage.Literals.CONNEXION__NET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Connexion_type");
	}
