	...
	protected void addCiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Commentaire_cible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Commentaire_cible_feature", "_UI_Commentaire_type"),
				 NetlistPackage.Literals.COMMENTAIRE__CIBLE,
				 true,
				 false,
				 true,
				 null,
