 ...
 * </p>
 * <ul>
 *   <li>{@link layout.impl.BoardImpl#getName <em>Name</em>}</li>
...
public class BoardImpl extends MinimalEObjectImpl.Container implements Board {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.BOARD__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LayoutPackage.BOARD__NAME:
				return getName();
