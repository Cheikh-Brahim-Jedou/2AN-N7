...
public class LayoutFactoryImpl extends EFactoryImpl implements LayoutFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case LayoutPackage.COUCHEEXTERNE: return createCoucheexterne();
			case LayoutPackage.COUCHEINTERNE: return createCoucheinterne();
			case LayoutPackage.COMPOSANT_PLACE: return createComposantPlace();
	 ...
	 */
	@Override
	public ComposantPlace createComposantPlace() {
		ComposantPlaceImpl composantPlace = new ComposantPlaceImpl();
		return composantPlace;
	}
