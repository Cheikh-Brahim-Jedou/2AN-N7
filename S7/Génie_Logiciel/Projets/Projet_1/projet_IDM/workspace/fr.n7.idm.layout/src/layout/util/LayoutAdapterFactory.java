...
public class LayoutAdapterFactory extends AdapterFactoryImpl {
	...
	protected LayoutSwitch<Adapter> modelSwitch =
		new LayoutSwitch<Adapter>() {
			...
			@Override
			public Adapter caseComposantPlace(ComposantPlace object) {
				return createComposantPlaceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link layout.Coucheexterne <em>Coucheexterne</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link layout.Coucheinterne <em>Coucheinterne</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link layout.ComposantPlace <em>Composant Place</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createComposantPlaceAdapter() {
		return null;
	}
