 ...
 * </p>
 * <ul>
 *   <li>{@link netlist.impl.InstanceComposantImpl#getConnexions <em>Connexions</em>}</li>
 *   <li>{@link netlist.impl.InstanceComposantImpl#getComposant <em>Composant</em>}</li>
...
public class InstanceComposantImpl extends MinimalEObjectImpl.Container implements InstanceComposant {
	...
	public Composant getComposant() {
		if (composant != null && composant.eIsProxy()) {
			...
			if (composant != oldComposant) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NetlistPackage.INSTANCE_COMPOSANT__COMPOSANT, oldComposant, composant));
			}
		}
		return composant;
	}
	...
	public void setComposant(Composant newComposant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetlistPackage.INSTANCE_COMPOSANT__COMPOSANT, oldComposant, composant));
	}
	...
	public EList<Connexion> getConnexions() {
		if (connexions == null) {
			connexions = new EObjectContainmentEList<Connexion>(Connexion.class, this, NetlistPackage.INSTANCE_COMPOSANT__CONNEXIONS);
		}
		return connexions;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NetlistPackage.INSTANCE_COMPOSANT__COMPOSANT:
