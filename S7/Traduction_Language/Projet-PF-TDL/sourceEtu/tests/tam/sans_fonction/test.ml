...
let%expect_test "testPointeurSimple" =
  runtam (pathFichiersRat^"testPointeurSimple.rat");
  [%expect{| 5 |}]
...
let%expect_test "testPointeurBool" =
  runtam (pathFichiersRat^"testPointeurBool.rat");
  [%expect{| 0 |}]
