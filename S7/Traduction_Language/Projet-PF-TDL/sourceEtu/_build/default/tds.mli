...
type info =
  ...
  son type, et son adresse ie son déplacement (int) par rapport à un registre (string) et un booléen indiquant si c'est une référence *)
  ...
  | InfoFun of string * typ * typ list * bool list
   (* Information associée à une énumération : son nom et la liste des constantes qu'elle définit *)
...
val modifier_type_fonction : typ -> typ list -> bool list -> info_ast -> unit
