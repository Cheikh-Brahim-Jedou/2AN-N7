...
enum : ENUM n=TID AO lv=separated_list(VIRG, TID) AF PV  {(n,lv)}

fonc : t=typ n=ID PO lp=separated_list(VIRG,param) PF li=bloc {Fonction(t,n,lp,li)}

param : t=typ n=ID  {(t,n , false)}
      | REF t=typ n=ID  {(t,n , true)}

affectable : n=ID {Ident n}
           | PO MULT a=affectable PF  {Deref a}

bloc : AO li=i* AF      {li}

i :
| t=typ n=ID EQUAL e1=e PV          {Declaration (t,n,e1)}
| a=affectable EQUAL e1=e PV                {Affectation ( a,e1)}
...
| NULL                    {Null }
| ADRESS n=ID             {Adresse n}
| REF n =ID               {Ref n}
| a=affectable            {Affectable a}
| n = TID                 {Affectable( Ident n) }